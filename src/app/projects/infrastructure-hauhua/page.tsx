...
export default function InfrastructureHauhuaDetailPage() {
  ...
  const projectData = {
    ...
    images: [
      "/products/hauhua-binh-phuoc.jpg",
      "/products/hauhua-binh-phuoc2.jpg",
      "/products/hauhua-binh-phuoc3.jpg",
      "/products/hauhua-binh-phuoc4.jpg",
      "/products/hauhua-binh-phuoc5.jpg",
      "/products/hauhua-binh-phuoc6.jpg",
    ],
    workDetails: [
      "Hoàn thiện hệ thống tưới thoát nước mưa với công nghệ hiện đại, đảm bảo khả năng thoát nước tốt.",
      "Hoàn thiện hạng mục nền đường bê tông đạt tiêu chuẩn kỹ thuật cao, chịu tải trọng lớn.",
      "Thi công hệ thống cống thoát nước với kích thước và độ dốc phù hợp địa hình.",
      "Lắp đặt hệ thống lưới thu gom nước mưa tại các điểm chiến lược.",
      "Thi công nền đường với độ dày và cấp phối đảm bảo độ bền lâu dài.",
      "Hoàn thiện bề mặt đường với lớp phủ chống thấm và chống nứt.",
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-orange-50 via-background to-yellow-50 overflow-hidden">
        <div className="absolute inset-0 bg-[url('/products/hauhua-binh-phuoc.jpg')] bg-cover bg-center opacity-5"></div>
              ...
              >
                ...
                <div className="mb-8">
                  <div className="flex items-center mb-4">
                    <div className="p-4 bg-yellow-100 rounded-2xl mr-4">
                      <CalendarToday className="w-7 h-7 text-yellow-600" />
                    </div>
                    <Typography variant="h3" className="font-serif text-xl font-bold text-gray-900">
                      Thời gian thực hiện
                    </Typography>
                  ...
                  <div className="bg-green-50 rounded-2xl p-6 border border-green-100">
                    ...
                    <div className="flex items-center mt-3 text-gray-600">
                      ...
                      <Typography variant="body2" className="text-sm">
                        Chuyên gia về hạ tầng kỹ thuật và công trình giao thông
                      </Typography>
                    </div>
                  </div>
                </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <div className="text-center mb-12">
            ...
            >
              Theo dõi tiến độ thi công hạ tầng kỹ thuật hiện đại
            </Typography>
          </div>
        ...
        >
          <div className="bg-gradient-to-r from-orange-50 via-yellow-50 to-orange-50 rounded-3xl p-12 border border-gray-200">
            <div className="flex flex-col items-center justify-center text-center">
              <Typography
                variant="h3"
              ...
              <Typography
                ...
                sx={{ mb: 2 }}
              >
                Liên hệ với chúng tôi để được tư vấn chi tiết về thi công hạ tầng kỹ thuật và nhận báo giá tốt nhất
              </Typography>
            </div>
